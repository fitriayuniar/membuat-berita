...
async function fetchNews(loadMore = false) {
  ...
  try {
    ...
    if (data.articles && data.articles.length > 0) {
      ...
      if (data.articles.length >= 9) loadMoreBtn.style.display = "block";
    } else {
...
const localArticles = [
  ...
  },
  {
    ...
    description: 'XPeng Indonesia secara resmi menghadirkan diler flagship terbarunya di Pondok Indah, Jakarta Selatan.',
  ...
  {
    source: { name: 'Bola.com' },
    title: 'Peringkat FIFA Terbaru Tim-Tim ASEAN: Thailand Kembali ke 100 Besar, Indonesia Turun',
    description: 'Timnas Thailand menempati posisi ke-96 dalam sistem peringkat FIFA, sementara Indonesia mengalami penurunan peringkat.',
    url: 'https://www.bola.com/indonesia/read/6188290/peringkat-fifa-terbaru-tim-tim-asean-thailand-kembali-ke-100-besar-indonesia-turun',
    urlToImage: 'https://www.bola.com/images/2025/10/17/fifa-asean.jpg',
